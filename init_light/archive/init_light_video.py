...
contours, hierarchy = cv2.findContours(image=frame_light_transition, mode=cv2.RETR_TREE, method=cv2.CHAIN_APPROX_NONE)

# draw contours on the original image
image_copy = frame_light_transition.copy()
cv2.drawContours(image=image_copy, contours=contours, contourIdx=-1, color=(100, 100, 100), thickness=2, lineType=cv2.LINE_AA)
